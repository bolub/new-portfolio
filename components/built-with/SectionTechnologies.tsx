...
import { CustomBuiltWith } from '../../server/modules/built-width-service/interface';
  ...
  return (
    <chakra.section id={title} mb={20}>
      ...
      <SimpleGrid columns={{ base: 1, sm: 2, md: 3, lg: 5 }} spacing={0} mt={5}>
        {data?.map((fd) => {
          return (
            <a key={fd?.id} href={fd?.image_url} target='__blank'>
              <Flex
                flexDir='column'
                ...
                bg='white'
              >
                <Image h='auto' maxW='80px' src={fd?.image_url} />
